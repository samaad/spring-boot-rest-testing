...
public class ToDoControllerTest {
	...
	@Test
	public void verifyAllToDoById() throws Exception {
	...
	public void verifyDeleteToDo() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.get("/todo/4").accept(MediaType.APPLICATION_JSON))
	...
	public void verifyInvalidToDoIdToDelete() throws Exception{
		mockMvc.perform(MockMvcRequestBuilders.get("/todo/9").accept(MediaType.APPLICATION_JSON))
		.andExpect(jsonPath("$.errorCode").value(404))
